...
TOTAL_MS       = 3500                  # full splash duration
DROP_COUNT     = 5                     # honey drops falling from top
DROP_START_MS  = 0                     # drops start immediately
DROP_END_MS    = 1500                  # last drop splats by here
POOL_START_MS  = 600                   # pool begins rising once first drop lands
POOL_FULL_MS   = 2400                  # pool reaches its final height
LOGO_START_MS  = 2000                  # wordmark begins fading in
LOGO_FULL_MS   = 2900                  # wordmark fully visible
FADE_START_MS  = 3100                  # final fade-out begins

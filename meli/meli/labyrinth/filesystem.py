...
class FakeFS:
    ...
    def list_dir(self, path: str | None = None) -> list[tuple[str, str]]:
        ...
        if layout is not None:
            self._dir_cache[p] = list(layout)
            return layout
        generated = self._procedurally_generate(p)
        self._dir_cache[p] = generated
        return generated
    ...
    def read_file(self, path: str) -> str:
        ...
        # Special-cased fake content for files that real attackers
        # always check first. The point isn't accuracy — it's looking
        # plausible enough that they spend another 10 minutes reading.
